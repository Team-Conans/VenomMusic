...
from VenomMusic.modules.play import generate_cover
from VenomMusic.modules.play import arq
from VenomMusic.modules.play import cb_admin_check
from VenomMusic.modules.play import transcode
from VenomMusic.modules.play import convert_seconds
from VenomMusic.modules.play import time_to_seconds
from VenomMusic.modules.play import changeImageSize
from VenomMusic.config import BOT_NAME as bn
from VenomMusic.config import DURATION_LIMIT
from VenomMusic.config import UPDATES_CHANNEL as updateschannel
from VenomMusic.config import que
from VenomMusic.function.admins import admins as a
from VenomMusic.helpers.errors import DurationLimitError
from VenomMusic.helpers.decorators import errors
from VenomMusic.helpers.admins import get_administrators
from VenomMusic.helpers.channelmusic import get_chat_id
from VenomMusic.helpers.decorators import authorized_users_only
from VenomMusic.helpers.filters import command, other_filters
from VenomMusic.helpers.gets import get_file_name
from VenomMusic.services.callsmusic import callsmusic, queues
from VenomMusic.services.callsmusic.callsmusic import client as USER
from VenomMusic.services.converter.converter import convert
from VenomMusic.services.downloaders import youtube
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/713804e848f1a9751cb7c.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Venommusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/713804e848f1a9751cb7c.jpg"
